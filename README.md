...
00 6 * * 0-6 bash -l -c 'cd /home/ubuntu/DAWN && julia --project scripts/signals.jl 1'
05 6 * * 0-6 bash -l -c 'cd /home/ubuntu/DAWN && julia --project scripts/signals.jl 2'
10 6 * * 0-6 bash -l -c 'cd /home/ubuntu/DAWN && julia --project scripts/signals.jl 3'
15 6 * * 0-6 bash -l -c 'cd /home/ubuntu/DAWN && julia --project scripts/feedback.jl 1'
20 6 * * 0-6 bash -l -c 'cd /home/ubuntu/DAWN && julia --project scripts/feedback.jl 2'
25 6 * * 0-6 bash -l -c 'cd /home/ubuntu/DAWN && julia --project scripts/feedback.jl 3'
30 8 * * 1 bash -l -c 'cd /home/ubuntu/DAWN && julia --project scripts/compliance.jl 1'
35 8 * * 1 bash -l -c 'cd /home/ubuntu/DAWN && julia --project scripts/compliance.jl 2'
40 8 * * 1 bash -l -c 'cd /home/ubuntu/DAWN && julia --project scripts/compliance.jl 3'
